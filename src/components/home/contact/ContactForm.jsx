    ...
    return (
        <form action="" className='contact_form' data-animation="appear">
            ...
            <div className="form-group">
                ...
                <input className='contact_form_input' type="text" name="name" id="name" />
            </div>
            
            <div className="form-group">
                <label htmlFor="email">Email</label>
                <input className='contact_form_input' type="email" name="email" id="email" />
            </div>
            ...
            <div className="form-group">
                ...
                <textarea className='contact_form_input' name="message" id="message" cols="30" rows="10"></textarea>
            </div>
